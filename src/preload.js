...
/**
 * HERE YOU WILL EXPOSE YOUR 'download_pdf' FROM main.js
 * TO THE FRONTEND.
...
contextBridge.exposeInMainWorld(
    "api", {
        invoke: (channel, data) => {
            let validChannels = ["download_pdf", "save_json", "print"]; // list of ipcMain.handle channels you want access in frontend to
